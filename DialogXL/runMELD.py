...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_sent_len', type=int, default=100, # according to the pre-trained transformer-xl
    ...
    parser.add_argument('--windowp', type=int, default=2, help='local attention window size')
    ...
    parser.add_argument('--lognum', type=int,  default=9999, help='Log number')
    ...
    for e in range(n_epochs):
        ...
        valid_loss, valid_acc, _, _, valid_fscore,_ = eval_model_for_transfo_xl(model, loss_function,
                                                                                             valid_loader, e, cuda, args, n_classes, dev_size)
        
        test_loss, test_acc, test_label, test_pred, test_fscore,_ = eval_model_for_transfo_xl(model,
                                                                                                           loss_function,
                                                                                                           test_loader,
