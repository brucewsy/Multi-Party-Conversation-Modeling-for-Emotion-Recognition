...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_sent_len', type=int, default=150, # according to the pre-trained transformer-xl
    ...
    parser.add_argument('--dataset_name', default='EmoryNLP',  type= str, help='dataset name, IEMOCAP or MELD or DailyDialog')

    parser.add_argument('--max_grad_norm', type=float, default=5.0, help='Gradient clipping.')

    parser.add_argument('--lr', type=float, default=7e-6, metavar='LR', help='learning rate')
    ...
    parser.add_argument('--num_heads', nargs='+', type=int, default=[1, 2, 4, 5],
